...
def thermal_properties(input_data):
    ...
    a = 6.35e-4  # Radius of the thermo-TDR probe [m]
    C0 = 2.84e6  # Volumetric heat capacity of the probes [MJ m-3 K-1]
    r1 = 0.006922383  # Probe spacing for T1 [m]
    r3 = 0.008395067  # Probe spacing for T3 [m]
    t1 = 7  # Starting time of heating
    t2 = t1 - 1  # Time before heating
    t0 = 10  # Heat pulse width [s]
    R = 887.6  # Resistance of the heating element [Ohm]
